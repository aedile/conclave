...
migrate_signatures  # unused function — Click command (bootstrapper/cli.py:audit_group)
log_event  # unused function — Click command (bootstrapper/cli.py:audit_group)
...
_validate_production_required_fields  # unused method — Pydantic model_validator (shared/settings.py T57.3)
...
_warn_rate_limit_window_mismatch  # Pydantic model_validator — emits WARNING when CONCLAVE_RATE_LIMIT_WINDOW_SECONDS != 60 (settings_models.py T74.2 red-team fix)
